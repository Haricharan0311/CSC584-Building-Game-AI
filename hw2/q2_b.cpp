...
float SteeringBehaviour::timeToTargetVelocity= 0.05f;
float SteeringBehaviour::timeToTargetRotation=0.05f;
float SteeringBehaviour::radiusOfSatisfaction= 5.0f;
float SteeringBehaviour::radiusOfDeceleration=50.0f;
...
int main() {
    sf::RenderWindow window(sf::VideoMode(640, 480), "Mouse Control with Breadcrumbs- Fast and Snappy");
